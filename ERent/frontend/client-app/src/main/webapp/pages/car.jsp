...
<%
    ...
    request.setAttribute("pageTitle", "Rent a Car");
...
<div class="admin-layout">
    ...
    <main class="content">
        ...
        <div class="page-container">
            <h3>Select your car rental options here</h3>
            <p>Form for choosing location, payment, and confirming the car rental will go here.</p>
        </div>
    </main>
</div>
</body>
